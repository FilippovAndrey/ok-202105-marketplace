...
class AvailableCreator {
    ...
    private fun dayAndTimeOfWeek(day: DayOfWeek, time: String) {
        ...
        _availableList.add(LocalDateTime.of(dDay, dTime))
    }
...
class UserBuilder {
    ...
    var available = mutableListOf<LocalDateTime>()
...
@UserDsl
fun UserBuilder.contacts(block: ContractsContext.() -> Unit) {
    val context = ContractsContext().apply(block)
